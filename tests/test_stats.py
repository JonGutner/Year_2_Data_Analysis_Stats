...
class TestMLE(unittest.TestCase):
    def test_gaussian(self):
        ...
        outputer.show_fit(data, pdfs.gaussian, result["params"], "Test_Runs",
                          title="Gaussian")
    ...
    def test_exponential(self):
        ...
        outputer.show_fit(data, pdfs.exponential, result["params"], "Test_Runs",
                          title="Exponential")
    ...
    def test_poisson(self):
        ...
        outputer.show_fit(data, pdfs.poisson_pmf, result["params"], "Test_Runs",
                          title="Poisson")
    ...
    def test_binomial(self):
        ...
        outputer.show_fit(data, pdf, result["params"], "Test_Runs",
                          title="Binomial")
    ...
    def test_lorentzian(self):
        ...
        outputer.show_fit(data, pdfs.lorentzian, result["params"], "Test_Runs",
                          title="Lorentzian")
